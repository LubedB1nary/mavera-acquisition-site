...
const defaultScripts = [
  ...
  { title: '"Watch for Series B announcements and alert me"', steps: ['websearch', 'research', 'outcomes', 'notify'] },
  { title: '"Prep me for my 3pm with Northwind"', steps: ['meetings', 'research', 'crm', 'docs', 'notify'] },
];
